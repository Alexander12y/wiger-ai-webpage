    ...
    <div className="min-h-screen" style={{ background: '#0E1C2F' }}>
      ...
      >
        <div className="flex items-center gap-4">
          <Image src="/wiger-logo.png" alt="Wiger AI" width={120} height={34} className="h-8 w-auto object-contain" />
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
            ...
            <path fillRule="evenodd" d="M19 10a.75.75 0 00-.75-.75H8.704l1.048-1.07a.75.75 0 10-1.004-1.115l-2.5 2.5a.75.75 0 000 1.115l2.5 2.5a.75.75 0 101.004-1.115l-1.048-1.07h9.546A.75.75 0 0019 10z" clipRule="evenodd" />
          </svg>
          Cerrar sesión
        </button>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 lg:px-10 py-12">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="font-bold text-base mb-1 group-hover:text-[#E8650A] transition-colors duration-200" style={{ color: '#F1EEE9' }}>
                    {section.name}
                  </h2>
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      ...
                      style={{ background: 'rgba(232,101,10,0.12)', color: '#E8650A', border: '1px solid rgba(232,101,10,0.25)' }}
                    >
        ...
        >
          ...
          <p style={{ color: '#94A3B8' }}>
            Los archivos subidos reemplazan los existentes en el servidor de forma inmediata. Para producción en Vercel, conecta un proveedor de almacenamiento en la nube (S3, Cloudinary, etc.).
          </p>
        </div>
      </main>
    </div>
...
export default function AdminPage() {
  ...
  if (view === 'section' && currentSection && token) {
    return <SectionView section={currentSection} token={token} onBack={handleBack} />
  }

  return <DashboardView onSelectSection={handleSelectSection} onLogout={handleLogout} />
}
